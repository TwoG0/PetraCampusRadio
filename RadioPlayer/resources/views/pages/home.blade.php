        ...
        <div class="p-4 rounded-lg dark:border-gray-700 mt-16">
            <div class="grid grid-cols-2 gap-4 mb-4">
                <div class="col-span-1">
                    <div class="flex justify-center h-24 mb-4 rounded text-5xl font-bold">
                ...
                <div class="col-span-1 pl-12" id="frame01">
                    <script id="cid0020000361197482498" data-cfasync="false" async src="//st.chatango.com/js/gz/emb.js"
                        style="width: 100%;height: 100%;">
                        {
                            "handle": "petracampusradio",
                            "arch": "js",
                            "styles": {
                                "a": "FFBC64",
                                "b": 100,
